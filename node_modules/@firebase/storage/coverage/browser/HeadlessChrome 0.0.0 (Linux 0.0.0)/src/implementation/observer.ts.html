...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/observer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> observer.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(
    ...
    if (asFunctions) {
      ...
      this.error = observer.error || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
      this.complete = observer.complete || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    }
  }
}
&nbsp;</pre></td></tr>
