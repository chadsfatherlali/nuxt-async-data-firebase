...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/blob.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> blob.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(data: Blob | Uint8Array | ArrayBuffer, opt_elideCopy?: boolean) {
    ...
    if (type.isNativeBlob(data)) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (opt_elideCopy) {
<span class="cstat-no" title="statement not covered" >        this.data_ = new Uint8Array(data);</span>
      } else {
        this.data_ = new Uint8Array(data.byteLength);
        this.data_.set(new Uint8Array(data));
      }
      size = this.data_.length;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (data instanceof Uint8Array) {
      if (opt_elideCopy) {
...
&nbsp;
  slice(startByte: number, endByte: number): FbsBlob | null {
    if (type.isNativeBlob(this.data_)) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (sliced === null) {
