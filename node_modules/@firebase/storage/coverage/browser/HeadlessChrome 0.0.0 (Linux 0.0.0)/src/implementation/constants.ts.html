...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/constants.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> constants.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >export function setDomainBase(</span>domainBase: string) {
<span class="cstat-no" title="statement not covered" >  domainBase = domainBase;</span>
}
&nbsp;
