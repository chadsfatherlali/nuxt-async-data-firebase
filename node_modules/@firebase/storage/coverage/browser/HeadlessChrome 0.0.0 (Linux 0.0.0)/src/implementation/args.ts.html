...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/args.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> args.ts
    </h1>
    <div class='clearfix'>
...
export function validate(name: string, specs: ArgSpec[], passed: IArguments) {
  ...
  for (let i = 0; i &lt; passed.length; i++) {
    try {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (e instanceof Error) {
<span class="cstat-no" title="statement not covered" >        throw errorsExports.invalidArgument(i, name, e.message);</span>
      } else {
...
&nbsp;
  constructor(validator: (p1: any) =&gt; void, opt_optional?: boolean) {
    ...
    this.validator = function(p: any) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (self.optional &amp;&amp; !type.isJustDef(p)) {
...
export function looseObjectSpec(
  ...
  function validator(p: any) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isLooseObject) {
<span class="cstat-no" title="statement not covered" >      throw 'Expected an Object.';</span>
    }
