...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/object.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> object.ts
    </h1>
    <div class='clearfix'>
...
export function forEach&lt;T&gt;(
  ...
  for (let key in obj) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (contains(obj, key)) {
      f(key, obj[key]);
    }
  }
}
