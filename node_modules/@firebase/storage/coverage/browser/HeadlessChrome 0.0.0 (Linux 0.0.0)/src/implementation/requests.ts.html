...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/requests.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> requests.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">95.14% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>176/185</span>
      </div>
      <div class='fl pad1y space-right2'>
...
export function handlerCheck(cndn: boolean) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!cndn) {
<span class="cstat-no" title="statement not covered" >    throw errorsExports.unknown();</span>
  }
}
&nbsp;
...
export function sharedErrorHandler(
  ...
  function errorHandler(
    ...
    let newErr;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (xhr.getStatus() === 401) {
<span class="cstat-no" title="statement not covered" >      newErr = errorsExports.unauthenticated();</span>
    } else {
      if (xhr.getStatus() === 402) {
        newErr = errorsExports.quotaExceeded(location.bucket);
      } else {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (xhr.getStatus() === 403) {
<span class="cstat-no" title="statement not covered" >          newErr = errorsExports.unauthorized(location.path);</span>
        } else {
          newErr = err;
        }
      }
...
export function determineContentType_(
  ...
  return (
    (metadata &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >metadata['contentType'])</span> ||
    (blob &amp;&amp; blob.type()) ||
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (body === null) {
<span class="cstat-no" title="statement not covered" >    throw errorsExports.cannotSliceBlob();</span>
  }
...
<span class="cstat-no" title="statement not covered" >    handlerCheck(false);</span>
  }
...
export function continueResumableUpload(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (blob.size() !== status.total) {
<span class="cstat-no" title="statement not covered" >    throw errorsExports.serverFileWrongSize();</span>
  }
  let bytesLeft = status.total - status.current;
  let bytesToUpload = bytesLeft;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (chunkSize &gt; 0) {
