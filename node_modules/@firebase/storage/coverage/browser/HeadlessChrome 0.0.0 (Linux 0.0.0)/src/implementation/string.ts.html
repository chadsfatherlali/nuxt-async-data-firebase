...
<html lang="en">
<head>
    <title>Code coverage report for src/implementation/string.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/implementation</a> string.ts
    </h1>
    <div class='clearfix'>
  ...
  switch (format) {
    case StringFormat.BASE64: {
      ...
      if (hasMinus || hasUnder) {
        let invalidChar = hasMinus ? '-' : <span class="branch-1 cbranch-no" title="branch not covered" >'_';</span>
        throw errorsExports.invalidFormat(
          format,
          "Invalid character '" +
            invalidChar +
    ...
    case StringFormat.BASE64URL: {
      ...
      if (hasPlus || hasSlash) {
        let invalidChar = hasPlus ? '+' : <span class="branch-1 cbranch-no" title="branch not covered" >'/';</span>
        throw errorsExports.invalidFormat(
          format,
...
<span class="cstat-no" title="statement not covered" >    throw errorsExports.invalidFormat(format, 'Invalid character found');</span>
  }
...
function endsWith(s: string, end: string): boolean {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!longEnough) {
