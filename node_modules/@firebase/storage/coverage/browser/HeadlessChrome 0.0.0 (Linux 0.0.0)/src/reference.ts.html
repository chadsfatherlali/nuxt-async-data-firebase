...
<html lang="en">
<head>
    <title>Code coverage report for src/reference.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> reference.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  get storage(): Service {</span>
<span class="cstat-no" title="statement not covered" >    return this.authWrapper.service();</span>
  }
&nbsp;
  /**
...
&nbsp;
  ...
  getDownloadURL(): Promise&lt;string&gt; {
    ...
    return this.getMetadata().then(<span class="fstat-no" title="function not covered" >function(</span>metadata) {
      let url = (<span class="cstat-no" title="statement not covered" >metadata['downloadURLs'] as string[])[0];</span>
<span class="cstat-no" title="statement not covered" >      if (type.isDef(url)) {</span>
<span class="cstat-no" title="statement not covered" >        return url;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        throw errorsExports.noDownloadURL();</span>
      }
    });
  }
&nbsp;
